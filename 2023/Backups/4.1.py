...
def detectar_area_resgate():
    # Defina os valores mínimos e máximos de R, G e B que correspondem à área de resgate
    # Estes valores podem variar dependendo das cores específicas da área de resgate
    r_min =  10 
    r_max =  18 
    g_min =  9 
    g_max =  16 
    ...
    # Aguarde até que os valores RGB estejam dentro dos limites da área de resgate
